...
$cmtx_mysql_database = 'urdunote_comm';				// The name of the database you created
$cmtx_mysql_username = 'urdunote_commu'; 				// Your MySQL username
$cmtx_mysql_password = 'hailmyass1';			 	// Your MySQL password
